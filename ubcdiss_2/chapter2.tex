...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.75]{dna_input_amp_yield_xlabel.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.13]{amp_norm_depth_med_wilcoxon_volcano_85_xlabel_color_length_discrete.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.8]{amp_cov_lm_len_gc_85_ylabel_top_100.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.8]{deamination_effect_blood_ffpe_fc_ylabel.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.58]{deamination_effect_age_amp_yield_ylabel.png}
...
Several studies reported increased fragmentation damages in DNA isolated from older paraffin blocks due to longer exposure to environmental conditions \cite{Bass2014, Carrick2015, Ludyga2012, Seiler2016}.

There are also studies that revealed increased frequency of sequence artifacts in FFPE DNA that are exceedingly fragmented \cite{Carrick2015, Wong2014}.
