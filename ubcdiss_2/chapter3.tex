...
\chapter{Concordance of Germline PGx Variants Between Blood and Tumours}
\label{ch:ConcordanceofGermlinePGxVariantsBetweenBloodandTumours}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Variant Allele Frequency Thresholds Can Maximize Sensitivity and Positive Predictive Value of Germline Variant Calling in Tumours}
